						...
						<form action="../../../ProductServlet" method="post">
							<table class="min-w-full bg-white">
								<thead class="bg-gray-800 text-white">
									<tr>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">User Id</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">User name</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">First name</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Last name</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Gender</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Date of Birth</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Phone no</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Email</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Address</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Role</th>
										<th
								...
								<tbody class="text-gray-700">
									...
									<tr>
										...
										<td
											class="text-left py-3 px-4 uppercase font-semibold text-sm"><%=result.getString("user_name")%></td>
										<td
											class="text-left py-3 px-2 uppercase font-semibold text-sm"><%=result.getString("first_name")%></td>
										<td
											class="text-left py-3 px-2 uppercase font-semibold text-sm"><%=result.getString("last_name")%></td>
										<td
											class="text-left py-3 px-2 uppercase font-semibold text-sm"><%=result.getString("gender")%></td>
										<td
											class="text-left py-3 px-4 uppercase font-semibold text-sm"><%=result.getString("dob")%></td>
										<td
											class="text-left py-3 px-4 uppercase font-semibold text-sm"><%=result.getString("phone_number")%></td>
										<td
											class="text-left py-3 px-4 uppercase font-semibold text-sm"><%=result.getString("email")%></td>
										<td
											class="text-left py-3 px-4 uppercase font-semibold text-sm"><%=result.getString("address")%></td>
										<td
