				...
				<table class="min-w-full bg-white">
					...
					<tbody class="text-gray-700">
						<tr>
							...
							<td class="w-1/3 text-left py-2 px-4"><img alt=""
								src="../<%=product.getImg()%>"> <input class="py-2 px-2"
								id="img" name="img" type="file"></td>
							...
							<td class="text-left py-2 px-4"><input class="py-2 px-2"
								id="price" name="price" type="number" placeholder="10"></td>
							<td></td>
						</tr>
					</tbody>
				</table>
