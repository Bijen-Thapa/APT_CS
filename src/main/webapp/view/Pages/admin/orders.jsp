						...
						<form action="../../../ProductServlet" method="post">
							<table class="min-w-full bg-white">
								<thead class="bg-gray-800 text-white">
									<tr>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Order
											ID</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">User</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Quantity</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Status</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Ordered
											date</th>
										<th
								...
								<tbody class="text-gray-700">
									...
									try (Connection con = dbCon.getConnection()) {
										...
										while (result.next()) {
											...
											PreparedStatement st2 = con.prepareStatement(StringUtil.GET_ORDER_list);
											ResultSet orderList = st2.executeQuery();
...
<!-- 										<td -->
<%-- 											class="text-left py-3 px-4 uppercase font-semibold text-sm"><%=name.getString("user_name")%></td> --%>
<!-- 										<td -->
<%-- 											class="text-left py-3 px-2 uppercase font-semibold text-sm"><%=qty%></td> --%>
<!-- 										<td -->
<%-- 											class="text-left py-3 px-2 uppercase font-semibold text-sm"><%=orderList.getString("status")%></td> --%>
										<td
