							...
							<table class="min-w-full bg-white">
								...
								<tbody class="text-gray-700">
									<tr>
										...
										<td class="text-left py-2 px-4"><input class="py-2 px-2"
											id="name" name="name" type="text" placeholder="category name"></td>
										<td class="w-1/3 text-left py-2 px-4"><input
											class="py-2 px-2" id="description" name="description"
											type="text" placeholder="Something about the category"></td>
						...
						<form action="../../../ProductServlet" method="post">
							<table class="min-w-full bg-white">
								<thead class="bg-gray-800 text-white">
									<tr>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Category
											ID</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Name</th>
										<th
										...
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Number
											of products</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Date
											added</th>
										<th
											class="text-left py-3 px-4 uppercase font-semibold text-sm">Actions</th>
